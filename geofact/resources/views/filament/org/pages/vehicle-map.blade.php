<x-filament-panels::page>
    ...
    (function () {
        ...
        var defaultLat = 5.3599517;   // Abidjan centre
        ...
        var map = L.map('vehicle-map').setView([defaultLat, defaultLng], defaultZoom);
        ...
        // Custom marker icon using IKOMA orange
        ...
        vehicles.forEach(function (v) {
            ...
            var popup = '<div style="min-width:160px;font-family:sans-serif">'
                + '<div style="font-weight:700;font-size:14px;color:#1e3a5f;border-bottom:2px solid #f97316;padding-bottom:4px;margin-bottom:6px">'
                + v.plate
                + '</div>'
            ...
            L.marker(latlng, { icon: makeIcon(v.heading) })
                .addTo(map)
                .bindPopup(popup);
        });
