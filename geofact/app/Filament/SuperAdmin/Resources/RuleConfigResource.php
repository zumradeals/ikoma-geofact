...
/**
 * SuperAdmin uniquement — gère les valeurs par défaut système (organization_id = NULL).
 * Les org_admin ont leur propre page de surcharge dans le panel org.
 */
class RuleConfigResource extends Resource
{
    protected static ?string $model       = RuleConfig::class;
    protected static ?string $label       = 'Règle système';
    protected static ?string $pluralLabel = 'Règles système (défauts)';
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ...
                    ->after(function (RuleConfig $record): void {
                        RuleConfigResolver::clearCache($record->rule_id);
                    }),
            ])
            ->paginated(false);
    }
    ...
    {
        return [
            'index' => Pages\ListRuleConfigs::route('/'),
            'edit'  => Pages\EditRuleConfig::route('/{record}/edit'),
        ];
    }
}
